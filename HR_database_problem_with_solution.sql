...
/*29. Write a query to get the last word of the street address*/ 
   ...
   AS 'Last_word_of-_street_address' 
   FROM locations;
...
SELECT job_title, 
       SUBSTR(job_title,1, INSTR(job_title, ' ')-1) as first_word 
FROM jobs;
...
/*35. Write a query t display the first eight characters of the employees' first names and indicates the amounts of their salaries with '$' sign. Each '$' sign signifies a thousand dollars. Sort the data in descending order of salary */
